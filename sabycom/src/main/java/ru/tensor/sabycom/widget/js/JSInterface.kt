...
internal class JSInterface(
    ...
    private val onStartPageListener: OnStartPageListener
) {
    ...
    fun postMessage(data: String, targetOrigin: String) {
        ...
        when (dataJson.getString(ACTION)) {
            ...
            ACTION_START_PAGE -> {
                onStartPageListener.onStartPage()
            }
            else -> {
                //do nothing
            }
    ...
    private companion object {
        ...
        const val ACTION_START_PAGE = "startPage"
    ...
    fun interface OnStartPageListener {
        /**
         * Вызывается в момент готовности страницы.
         */
        @WorkerThread
        fun onStartPage()
    }
