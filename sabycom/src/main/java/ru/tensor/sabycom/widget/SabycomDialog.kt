...
internal class SabycomDialog : BottomSheetDialogFragment() {
    ...
    override fun onResume() {
        ...
        binding?.apply {
            ...
            webView.sendChatIdIfExist(viewModel.getChatIdAndForget(), channel)
        }
    }
    ...
    private fun sendChatId(chatId: String, channel: String): String {
    ...
    private fun WebView.sendChatIdIfExist(chatId: String?, channel: String) {
        chatId?.let { this.evaluateJavascript(sendChatId(it, channel)) {} }
    }
}
